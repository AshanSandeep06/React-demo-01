      ...
      <section className="mt-3.5 ml-4 flex flex-col gap-3">
        ...
        <div className="text-white flex gap-4">
          <button
            ...
            className="rounded border border-green-800 text-green-800 px-3 py-1.5 hover:bg-green-800 hover:text-white"
          >
            Increase
          </button>
          <button
            ...
            className="rounded border border-red-800 text-red-800 px-3 py-1.5 hover:bg-red-800 hover:text-white"
          >
            Decrease
          </button>
        </div>
